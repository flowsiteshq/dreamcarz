...
export function VehicleExperienceDialog({ vehicle, membershipPlan, open, onOpenChange, initialView = "overview" }: VehicleExperienceDialogProps) {
  ...
  const reserveLabel = isTeslaModel3Waitlist ? "Join Tesla Model 3 waiting list" : "Reserve your vehicle";
        ...
        {isReserve && (
          <div className="grid min-h-[720px] lg:grid-cols-[0.78fr_1.22fr]">
            <aside className="hidden bg-black px-10 py-14 text-white lg:block">
              ...
              <p className="mt-10 text-[11px] font-bold uppercase tracking-[0.2em] text-[#d1ad54]">{isRental ? "Rental request" : isPurchase ? "Purchase inquiry" : isTeslaModel3Waitlist ? "Tesla Model 3 waiting list" : "Reserve request"}</p>
              <h2 className="mt-3 font-display text-3xl font-bold tracking-[-0.045em]">{fullName}</h2>
              <p className="mt-4 text-sm leading-relaxed text-white/65">{isRental ? "Share your preferred dates and location. DreamCarz will review your request and guide you through any remaining rental requirements." : isPurchase ? "Share your preferred contact details. DreamCarz will follow up with the vehicle’s current purchase options and next steps." : isTeslaModel3Waitlist ? "Share your contact details to join the Tesla Model 3 waiting list. DreamCarz will follow up when an appropriate vehicle-access path is available." : "Share your contact details to reserve your interest. DreamCarz will follow up when an appropriate vehicle-access path is available."}</p>
            </aside>
            <div className="px-6 py-16 sm:px-12">
              ...
              <DialogHeader className="mt-8 text-left lg:mt-0">
                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#a8832d]">{isRental ? "Request a rental" : isPurchase ? "Ask about purchase" : isTeslaModel3Waitlist ? "Tesla Model 3 waitlist" : "Reserve your vehicle"}</p>
                <DialogTitle className="font-display text-4xl font-bold tracking-[-0.05em] text-black">{isRental ? "Start your rental request." : isPurchase ? "Send a purchase inquiry." : isTeslaModel3Waitlist ? "Join the Tesla Model 3 waiting list." : "Reserve your vehicle."}</DialogTitle>
                <DialogDescription className="max-w-xl leading-relaxed text-gray-600">{isRental ? "We will confirm vehicle availability, then help you complete the required rental steps." : isPurchase ? "We will confirm current availability and discuss the applicable purchase path directly with you." : isTeslaModel3Waitlist ? "Tesla Model 3s are Coming Soon. Submit your interest and DreamCarz will guide you when a suitable option is ready." : "This vehicle is labeled Coming Soon. Submit your interest and DreamCarz will guide you when a suitable option is ready."}</DialogDescription>
              </DialogHeader>
