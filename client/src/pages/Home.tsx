      ...
      <main>
        <section className="border-b border-[#ebe7df] bg-[#fbfaf7] pt-24 lg:pt-28">
          <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-[0.94fr_1.06fr]">
            ...
            <div className="flex min-h-[360px] items-center justify-center overflow-hidden bg-[#f2eee6] lg:min-h-[500px]"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310419663031545745/gyIfJAbATfYnyeYI.png" alt="White Tesla Model 3 in a DreamCarz studio setting" className="h-full min-h-[360px] w-full object-cover lg:min-h-[500px]" /></div>
          </div>
