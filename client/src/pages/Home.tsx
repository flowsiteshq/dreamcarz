      ...
      <main>
        <section className="overflow-hidden bg-[#f7f5f0] pt-28">
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 pb-14 lg:grid-cols-[0.9fr_1.1fr] lg:px-10 lg:pb-20">
            ...
            <div className="flex min-h-[340px] items-center justify-center bg-[#ebe7de] p-6 lg:min-h-[510px]">
              <img src="/manus-storage/hero-car-white_b6931126.png" alt="DreamCarz premium vehicle" className="h-[310px] w-full object-contain lg:h-[470px]" />
            </div>
          </div>
