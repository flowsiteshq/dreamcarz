...
const welcome = (name: string | null | undefined, signedIn: boolean): Entry => ({
  id: "welcome",
  role: "concierge",
...
export default function Concierge() {
  ...
  const [history, setHistory] = useState<Entry[]>(() => [welcome(null, false)]);
  ...
  useEffect(() => {
    ...
    if (routeIntent !== "rental" && routeIntent !== "purchase") return;
    setIntent(routeIntent);
    append({ id: "route-intent", role: "concierge", text: routeIntent === "rental" ? "What do you need for your rental?" : "What are you looking for?" });
  }, []);
  ...
  const reset = () => {
    ...
    setIntent("explore"); setVehicleClass(null); setRecommendedIds(null); setSelectedVehicleId(null); setTimeline(null); setNotice("");
  };
