...
const confirmedInventory = [
  { year: 2024, make: "Chevrolet", model: "Malibu", color: "Gray", type: "Sedan", image: "/manus-storage/dreamcarz-semantic-2024-chevrolet-malibu-gray_81e4cdf5.png" },
  { year: 2022, make: "Chevrolet", model: "Traverse", color: "White", type: "SUV", image: "/manus-storage/dreamcarz-semantic-2022-chevrolet-traverse-white_40291761.png" },
  { year: 2024, make: "Ford", model: "Fusion", color: "Gray", type: "Sedan", image: "/manus-storage/dreamcarz-semantic-2024-ford-fusion-gray_f04eba96.png" },
  { year: 2020, make: "Chevrolet", model: "Traverse", color: "Gray", type: "SUV", image: "/manus-storage/dreamcarz-semantic-2020-chevrolet-traverse-gray_1762a642.png" },
  { year: 2019, make: "Chevrolet", model: "Malibu", color: "Black", type: "Sedan", image: "/manus-storage/dreamcarz-semantic-2019-chevrolet-malibu-black_9ccb6a25.png" },
  { year: 2015, make: "Ford", model: "Taurus", color: "Gray", type: "Sedan", image: "/manus-storage/dreamcarz-semantic-2015-ford-taurus-gray_3b5de791.png" },
  { year: 2020, make: "Chevrolet", model: "Equinox", color: "Gray", type: "SUV", image: "/manus-storage/dreamcarz-semantic-2020-chevrolet-equinox-gray_0258c250.png" },
  { year: 2020, make: "Chevrolet", model: "Equinox", color: "Black", type: "SUV", image: "/manus-storage/dreamcarz-semantic-2020-chevrolet-equinox-black_796700ab.png" },
] as const;
