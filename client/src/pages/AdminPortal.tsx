...
function AdminPortalOverview({ onOpen }: { onOpen: (section: string) => void }) {
  ...
  const metrics = [
    ...
    { label: "Needs attention", value: attention, note: "Inspection or service", section: "admin-maintenance", icon: AlertTriangle, tone: "text-amber-700" },
...
export default function AdminPortal() {
  ...
  useEffect(() => {
    if (activeSection === "admin-dashboard" || activeSection === "admin-integrations") return;
